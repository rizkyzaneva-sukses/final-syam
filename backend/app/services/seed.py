...
def seed(db: Session):
    ...
    o3 = Order(order_id="SO-021", buyer="TOKYO STYLE", order_type=OrderType.SAMPLE_ONLY, buyer_deadline=today+timedelta(days=14), finance_status="UNPAID", material_status="NOT_REQUESTED", shipment_status="NOT_READY", overall_status="NEW", projected_shipment=today+timedelta(days=12), buffer_days=2, created_by_id=users[1].id)
    ...
    o4 = Order(order_id="SO-033", buyer="BERLIN WEAR", order_type=OrderType.REPEAT_PRODUCTION, buyer_deadline=today+timedelta(days=10), finance_status="PAID", material_status="READY", shipment_status="NOT_READY", overall_status="ACTIVE", projected_shipment=today+timedelta(days=8), buffer_days=2, created_by_id=users[1].id)
    ...
    o5 = Order(order_id="SO-042", buyer="SEOUL FASHION", order_type=OrderType.SAMPLE_PRODUCTION, buyer_deadline=today+timedelta(days=21), finance_status="PARTIAL", material_status="READY", shipment_status="NOT_READY", overall_status="ACTIVE", projected_shipment=today+timedelta(days=18), buffer_days=3, created_by_id=users[1].id)
