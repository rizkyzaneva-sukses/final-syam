...
const empty={order_fk:'',article_code:'',process:'Cutting',total_checked:'',total_pass:'',total_reject:'',reject_reason:'',inspector:'',status:'PASS'};
const statusOpts=['PASS','FAIL'];
...
export default function QCRecordPage(){
  ...
  async function save(ev){
    ...
    try{
      const payload={...form,order_fk:form.order_fk?parseInt(form.order_fk):null,total_checked:parseInt(form.total_checked)||0,total_pass:parseInt(form.total_pass)||0,total_reject:parseInt(form.total_reject)||0};
      if(form.id){await api('/coo/qc-records/'+form.id,{method:'PATCH',body:JSON.stringify(payload)});}
  ...
  return <div className="page">
    ...
    <div className="table-scroll"><table><thead><tr><th>Order</th><th>Article</th><th>Process</th><th>Checked</th><th>Pass</th><th>Reject</th><th>Pass Rate</th><th>Inspector</th><th>Status</th><th>Aksi</th></tr></thead>
    ...
    {f2.length===0&&<tr><td colSpan={10} className="empty">Tidak ada QC record</td></tr>}</tbody></table></div>
