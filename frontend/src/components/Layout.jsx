...
const roleMenus={
  ...
  CMO_SUPPORT:[['CMO Home','/cmo',Home],['Order Management','/cmo/orders',ShoppingCart],['Customer / Buyer','/cmo/customers',Users],['Quotations','/cmo/quotations',FileText],['Sample / PPM','/cmo/samples',ClipboardList],['SPK','/cmo/spk',CheckSquare],['Master Control','/master',Database]],
