...
const routeRoles={
  ...
  '/cmo':groups.cmo,'/cmo/priority':[...groups.cmo,'CEO'],'/cmo/sales-pipeline':[...groups.cmo,'CEO'],'/cmo/reports':[...groups.cmo,'CEO'],'/cmo/buyer-crm':[...groups.cmo,'CEO'],'/cmo/sample-approval':[...groups.cmo,'CEO','SAMPLE_PIC'],'/cmo/release-to-coo':['CMO_MANAGER','CMO_SUPPORT','CEO'],'/cmo/exception-center':['CMO_MANAGER','CMO_SUPPORT','CEO'],'/cmo/orders':groups.cmo,'/cmo/orders/new':groups.cmo,'/cmo/po-inbox':['CMO_MANAGER','CMO_SUPPORT','CEO'],'/cmo/customers':groups.cmo,
